\subsection {Vermessung der Solarzelle POW112D2P}                   % 2.2
    \subsubsection{Aufnehmen der I-U Kennlinie}                         % 2.2 a
        ...
        \vspace{4mm}
        \par Zur graphischen Darstellung wurde folgendes Matlab-Skript verwendet:
        
        \begin{figure}
            \lstinputlisting[style=Matlab, firstline=24, lastline=29]{messungen/Aufgabe_2_2/Messungen_2.5cm_40Watt_LED/stromstarke_spannung.m}
            \caption{Matlab-Skript zur graphischen Darstellung der Spannung}
        \end{figure}
    ...
    \subsubsection{Bestimmung des Maximum-Power-Points (MPP)}           % 2.2 b
        ...
        Der Maximum Power Point (wird nun MPP abgekürzt) bezeichnet nun den Punkt, an dem die Leistung am größten ist. Dieser maximale Wert für die Leistung sowie der dementsprechende Widerstand lassen sich ablesen / von folgendem MatLab-Skript ausgeben:
        
        \lstinputlisting[style=Matlab, firstline=22, lastline=50]{messungen/Aufgabe_2_2/Messungen_2.5cm_40Watt_LED/stromstarke_leistung_spannung.m}
