\subsection {Langzeitmessung}                                       % 2.3
    \subsubsection{Spannungsverlauf und Leistung}                       % 2.3 a
        ...
        \par Die erzeugte Energie wurde mit folgendem Matlab coded ausgerechnet:
        
        \begin{figure}[H]
            \lstinputlisting[style=Matlab, firstline=17, lastline=25]{messungen/Aufgabe_2_3/import_data.m}
            \caption{Matlab code zur Berechnung der Energie}
        \end{figure}
