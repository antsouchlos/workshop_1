\subsection {Energiespeicherung und Verhalten von Solarzellen}      % 2.4
    \subsubsection{Theoretische Betrachtung}                            % 2.4 a
        ...
        \begin{figure}[H]
            \lstinputlisting[style=Matlab, lastline=44]{messungen/Aufgabe_2_4/theorie.m}
    ...
    \subsubsection{Messung}                                             % 2.4 b
        ...
        \begin{figure}[H]
            \lstinputlisting[style=Matlab, firstline=12, lastline=14]{messungen/Aufgabe_2_4/aufladen.m}
            \caption{Matlab code zur graphischen Darstellung des Spannungsverlaufes bei der Aufladung des Kondensators}
        \end{figure}
        
        \begin{figure}[H]
            \lstinputlisting[style=Matlab, firstline=12, lastline=14]{messungen/Aufgabe_2_4/entladen.m}
